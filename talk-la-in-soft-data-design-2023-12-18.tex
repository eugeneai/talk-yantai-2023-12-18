...
% 53 slides
% Technologies for digital monitoring and forecasting of the ecological situation of the Baikal natural territory
% 23 slides
...
\title[软件和数据设计中的逻辑方法]{Logical Approach in Software and Data Design\\软件和数据设计中的逻辑方法}
...
\date[2023]{2024, October, Hebei, China}
%\date{\today}
\maketitle
